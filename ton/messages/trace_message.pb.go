...
const file_ton_trace_message_proto_rawDesc = "" +
	"\n" +
	"\x17ton/trace_message.proto\x12\fton_messages\x1a\x17ton/block_message.proto\"\xc8\x01\n" +
	"\x05Trace\x12;\n" +
	"\vBlockHeader\x18\x01 \x01(\v2\x19.ton_messages.BlockHeaderR\vBlockHeader\x12;\n" +
	"\vTransaction\x18\x02 \x01(\v2\x19.ton_messages.TransactionR\vTransaction\x12\x14\n" +
	"\x05Depth\x18\x03 \x01(\rR\x05Depth\x12/\n" +
	"\bChildren\x18\x04 \x03(\v2\x13.ton_messages.TraceR\bChildren\"f\n" +
	"\fTraceMessage\x12)\n" +
	"\x05Chain\x18\x01 \x01(\v2\x13.ton_messages.ChainR\x05Chain\x12+\n" +
	"\x06Traces\x18\x02 \x03(\v2\x13.ton_messages.TraceR\x06Tracesb\x06proto3"

var (
	file_ton_trace_message_proto_rawDescOnce sync.Once
	file_ton_trace_message_proto_rawDescData []byte
)

func file_ton_trace_message_proto_rawDescGZIP() []byte {
	file_ton_trace_message_proto_rawDescOnce.Do(func() {
		file_ton_trace_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ton_trace_message_proto_rawDesc), len(file_ton_trace_message_proto_rawDesc)))
	})
...
func file_ton_trace_message_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ton_trace_message_proto_rawDesc), len(file_ton_trace_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
