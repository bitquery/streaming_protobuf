...
const file_evm_token_block_message_proto_rawDesc = "" +
	"\n" +
	"\x1devm/token_block_message.proto\x12\fevm_messages\x1a\x17evm/block_message.proto\"\xf9\x02\n" +
	"\tTokenInfo\x12$\n" +
	...
	"\fProtocolName\x18\x04 \x01(\tR\fProtocolName\x12\x12\n" +
	"\x04Name\x18\x05 \x01(\tR\x04Name\x12\x16\n" +
	"\x06Symbol\x18\x06 \x01(\tR\x06Symbol\x12\x1a\n" +
	"\bDecimals\x18\a \x01(\x05R\bDecimals\x12\x16\n" +
	"\x06HasURI\x18\b \x01(\bR\x06HasURI\x12\x1a\n" +
	"\bFungible\x18\t \x01(\bR\bFungible\x12\x18\n" +
	"\aAssetId\x18\n" +
	" \x01(\tR\aAssetId\x12*\n" +
	...
	"\x06Sender\x18\x04 \x01(\fR\x06Sender\x12\x1a\n" +
	"\bReceiver\x18\x05 \x01(\fR\bReceiver\x12\x16\n" +
	"\x06Amount\x18\x06 \x01(\fR\x06Amount\x12\x0e\n" +
	"\x02Id\x18\a \x01(\fR\x02Id\x12\x10\n" +
	"\x03URI\x18\b \x01(\tR\x03URI\x123\n" +
	"\bCurrency\x18\t \x01(\v2\x17.evm_messages.TokenInfoR\bCurrency\x12\x18\n" +
	"\aSuccess\x18\n" +
	" \x01(\bR\aSuccess\x12\x12\n" +
	...
	"\n" +
	"PreBalance\x18\x03 \x01(\fH\x00R\n" +
	"PreBalance\x88\x01\x01\x12 \n" +
	...
	"\x06Header\x18\x02 \x01(\v2\x19.evm_messages.BlockHeaderR\x06Header\x129\n" +
	"\tTransfers\x18\x05 \x03(\v2\x1b.evm_messages.TokenTransferR\tTransfers\x12:\n" +
	"\bL1Header\x18\x06 \x01(\v2\x19.evm_messages.BlockHeaderH\x00R\bL1Header\x88\x01\x01\x12S\n" +
	"\x13TransactionBalances\x18\a \x03(\v2!.evm_messages.TransactionBalancesR\x13TransactionBalancesB\v\n" +
	"\t_L1Headerb\x06proto3"

var (
	file_evm_token_block_message_proto_rawDescOnce sync.Once
	file_evm_token_block_message_proto_rawDescData []byte
)

func file_evm_token_block_message_proto_rawDescGZIP() []byte {
	file_evm_token_block_message_proto_rawDescOnce.Do(func() {
		file_evm_token_block_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_evm_token_block_message_proto_rawDesc), len(file_evm_token_block_message_proto_rawDesc)))
	})
...
func file_evm_token_block_message_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_evm_token_block_message_proto_rawDesc), len(file_evm_token_block_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
