...
var file_evm_token_block_message_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x65, 0x22, 0xf5, 0x01, 0x0a, 0x11, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x6c, 0x6f,
...
var file_evm_token_block_message_proto_goTypes = []any{
	...
	(*Signature)(nil),         // 4: evm_messages.Signature
	(*Chain)(nil),             // 5: evm_messages.Chain
	(*BlockHeader)(nil),       // 6: evm_messages.BlockHeader
}
var file_evm_token_block_message_proto_depIdxs = []int32{
	...
	4, // 2: evm_messages.TokenTransfer.TransactionSignature:type_name -> evm_messages.Signature
	5, // 3: evm_messages.TokenBlockMessage.Chain:type_name -> evm_messages.Chain
	6, // 4: evm_messages.TokenBlockMessage.Header:type_name -> evm_messages.BlockHeader
	1, // 5: evm_messages.TokenBlockMessage.Transfers:type_name -> evm_messages.TokenTransfer
	6, // 6: evm_messages.TokenBlockMessage.L1Header:type_name -> evm_messages.BlockHeader
