...
const file_evm_dex_block_message_proto_rawDesc = "" +
	"\n" +
	"\x1bevm/dex_block_message.proto\x12\fevm_messages\x1a\x17evm/block_message.proto\x1a\x1devm/token_block_message.proto\"\xe0\x03\n" +
	"\aDexInfo\x12$\n" +
	...
	"\tRecipient\x18\x05 \x01(\fR\tRecipient\"\xb1\x04\n" +
	"\bDexTrade\x12*\n" +
	...
	"\x06PoolId\x18\x0e \x01(\fR\x06PoolId\"\xe8\x01\n" +
