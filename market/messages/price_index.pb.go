...
type MarketCapUpdate struct {
	...
	FullyDilutedValuationUsd float64  `protobuf:"fixed64,2,opt,name=fullyDilutedValuationUsd,proto3" json:"fullyDilutedValuationUsd,omitempty"` // Fully diluted valuation (FDV) is a market cap if the max supply was in circulation
	CirculatingSupply        *float64 `protobuf:"fixed64,3,opt,name=circulatingSupply,proto3,oneof" json:"circulatingSupply,omitempty"`
	MaxSupply                *float64 `protobuf:"fixed64,4,opt,name=maxSupply,proto3,oneof" json:"maxSupply,omitempty"`
	MarketCap                *float64 `protobuf:"fixed64,5,opt,name=marketCap,proto3,oneof" json:"marketCap,omitempty"`
}
...
var file_market_price_index_proto_rawDesc = []byte{
	...
	0x75, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x55, 0x73, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52,
	0x18, 0x66, 0x75, 0x6c, 0x6c, 0x79, 0x44, 0x69, 0x6c, 0x75, 0x74, 0x65, 0x64, 0x56, 0x61, 0x6c,
	...
	0x20, 0x01, 0x28, 0x01, 0x48, 0x00, 0x52, 0x11, 0x63, 0x69, 0x72, 0x63, 0x75, 0x6c, 0x61, 0x74,
	0x69, 0x6e, 0x67, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x88, 0x01, 0x01, 0x12, 0x21, 0x0a, 0x09,
	0x6d, 0x61, 0x78, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x48,
	...
	0x28, 0x01, 0x48, 0x02, 0x52, 0x09, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x43, 0x61, 0x70, 0x88,
