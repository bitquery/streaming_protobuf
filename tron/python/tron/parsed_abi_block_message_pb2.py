...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PARSEDABITRANSACTION']._serialized_end=603
  _globals['_PARSEDABIBLOCKMESSAGE']._serialized_start=606
  _globals['_PARSEDABIBLOCKMESSAGE']._serialized_end=810
