...
const file_solana_dex_block_message_proto_rawDesc = "" +
	...
	"\rQuoteCurrency\x18\x03 \x01(\v2\x19.solana_messages.CurrencyR\rQuoteCurrency\"\xb0\x02\n" +
	"\bDexOrder\x12\x18\n" +
	...
	"\vInstruction\x18\x06 \x01(\v2%.solana_messages.ParsedIdlInstructionR\vInstruction\"\xa6\x01\n" +
	"\bPoolSide\x12\"\n" +
	...
	"\vInstruction\x18\x06 \x01(\v2%.solana_messages.ParsedIdlInstructionR\vInstruction\"\xe4\x01\n" +
	...
	"\vInstruction\x18\b \x01(\v2%.solana_messages.ParsedIdlInstructionR\vInstruction\"\xa3\x03\n" +
	...
	"PoolEvents\x12\x1a\n" +
	"\bFeeInUsd\x18\b \x01(\x02R\bFeeInUsd\"\x98\x01\n" +
