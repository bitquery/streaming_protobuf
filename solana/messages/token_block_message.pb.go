...
func (x *Currency) GetMultiplier() float64 {
	if x != nil {
		return x.Multiplier
	}
	return 0
...
const file_solana_token_block_message_proto_rawDesc = "" +
	...
	"\x05Share\x18\x03 \x01(\rR\x05Share\"\xf6\a\n" +
	"\bCurrency\x12\x12\n" +
	...
	"\vTotalSupply\x18\x18 \x01(\x04R\vTotalSupply\x12\x1e\n" +
	"\n" +
	...
	"\vInstruction\x18\x05 \x01(\v2%.solana_messages.ParsedIdlInstructionR\vInstruction\"\xd2\x03\n" +
