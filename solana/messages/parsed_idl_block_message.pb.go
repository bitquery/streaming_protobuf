...
var file_solana_parsed_idl_block_message_proto_goTypes = []interface{}{
...
func file_solana_parsed_idl_block_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_solana_parsed_idl_block_message_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ParsedArgument); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_solana_parsed_idl_block_message_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_solana_parsed_idl_block_message_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ParsedIdlInstruction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_solana_parsed_idl_block_message_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ParsedIdlTransaction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_solana_parsed_idl_block_message_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ParsedIdlBlockMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_solana_parsed_idl_block_message_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_solana_parsed_idl_block_message_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
