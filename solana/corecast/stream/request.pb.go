...
var file_solana_corecast_request_proto_goTypes = []interface{}{
...
func file_solana_corecast_request_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_solana_corecast_request_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_solana_corecast_request_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_solana_corecast_request_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SubscribePoolsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_solana_corecast_request_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_solana_corecast_request_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_solana_corecast_request_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SubscribeBalanceUpdateRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_solana_corecast_request_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
